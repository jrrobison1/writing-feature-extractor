...
aesthemos_non_tooling_prompt = """Context: You will act in the role of a participant in this study.
...
You must adhere to the following schema. Do not provide additional text or commentary. Respond only given the schema provided.
-----
{format_instructions}
-----
