...
class AesthemosSadness(AesthemosFeature):
    """Feature extractor for the AETHEMOS sadness in the text."""

    @property
    def y_level_label(self) -> str:
        return "AESTHEMOS_SADNESS"
    ...
    def pydantic_docstring(self) -> str:
        return "To what degree did this passage make you feel melancholic or sad?"
